Config = {
    ...
    -- 无剪辑模式触发次数（达到次数后触发反作弊）
    NoClipTriggerCount = 3,
    
    -- 反作弊组件开关
    Components = {
         AntiCheat = true,           -- 综合反作弊（无敌模式/无限弹药等）
         AntiSpectate = true,        -- 反旁观模式
         AntiNoclip = true,          -- 反无剪辑模式 
         AntiCommands = true,        -- 反黑名单指令
         AntiKeys = true,            -- 反违规按键 
         AntiESX = true,             -- 反ESX非法调用
         AntiWeapons = true,         -- 反非法武器
         AntiRemoveOtherPlayersWeapons = true,  -- 阻止玩家移除他人武器
         AntiCancelAnimations = true,           -- 阻止取消他人动画（如踢出车辆）
         StopOtherPlayersGivingEachOtherWeapons = true,  -- 阻止玩家间武器交易（管理员菜单除外）
         ModMenuChecks = true,       -- 模组菜单检测（需同时启用客户端acloader.lua）
         StopUnauthorizedResources = true,     -- 阻止未授权资源加载
    },
    
    -- 触发封禁的组件
    BanComponents = {
        AntiSpectate = true,         -- 旁观模式
        AntiNoClip = true,           -- 无剪辑模式
        AntiCommands = true,         -- 黑名单指令
        AntiESX = true,              -- ESX非法调用
        AntiFakeMessage = true,      -- 伪造消息
        AntiBlacklistedEvent = true, -- 黑名单事件
        AntiWeapons = false,         -- 非法武器（注意：作弊者可能给他人武器）
    },
    
    -- 系统提示消息
    Messages = {
        NoClipTriggered = "检测到非法无剪辑行为，你已被封禁。申诉请提供封禁ID。",
        ChatMessageTriggered = "检测到伪造聊天消息，你已被封禁。申诉请提供封禁ID。",
        BlacklistedEventTriggered = "检测到黑名单事件触发 [{EVENT}]，你已被封禁。申诉请提供封禁ID。",
        BlacklistedEntity = "检测到创建黑名单实体 [{ENTITY}]，你已被踢出。重复违规将导致封禁。",
        UnauthorizedResources = "检测到未授权资源 [{RESOURCE}]，你已被封禁。申诉请提供封禁ID。",
        ProhibitedVariables = "检测到非法变量 [{VARIABLE}]，你已被封禁。申诉请提供封禁ID。",
        CommandsTriggered = "检测到黑名单指令 [{COMMAND}]，你已被封禁。申诉请提供封禁ID。",
        ESXTriggered = "检测到非法ESX调用，你已被封禁。申诉请提供封禁ID。",
        SpectateTriggered = "非工作人员非法旁观，你已被封禁。申诉请提供封禁ID。",
        BlacklistedWeaponTriggered = "检测到黑名单武器 [{WEAPON}]，你已被踢出..."
    },
	 -- 按键检测配置
    KickForKeys = false,  -- 是否踢出违规按键
    BlacklistedKeys = {    -- 黑名单按键组合
